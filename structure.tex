...
\usepackage{subcaption} % Required to include subimages
\usepackage{tikz,tikz-3dplot} % Required to include tikz images
\tikzset{
...
\usepackage[printonlyused,nolist]{acronym} % Include a list of acronyms
...
\makeoddfoot{plain}{}{}{} % page number on the bottom right
\makepagestyle{pter}
