...
\begin{figure}
	...
	\draw[-stealth,line width=0.15mm] (-2,0) --  (-2,-\axisl/\zd+0.35);
	\draw[-stealth,line width=0.15mm] (-1.75,0) -- (-1.75,-\axisl/\zd);
	\draw[-stealth,line width=0.15mm] (-1.5,0) -- (-1.5,-\axisl/\zd+0.05);
	\draw[-stealth,line width=0.15mm] (-1.25,0) -- (-1.25,-\axisl/\zd+0.21);
	\draw[-stealth,line width=0.15mm] (-1,0) --  (-1,-\axisl/\zd+0.45);
	\draw[-stealth,line width=0.15mm] (-0.75,0) -- (-0.75,-\axisl/\zd);
	\draw[-stealth,line width=0.15mm] (-0.5,0) -- (-0.5,-\axisl/\zd+0.1);
	\draw[-stealth,line width=0.15mm] (-0.25,0) -- (-0.25,-\axisl/\zd+0.2);
	
	\draw[-stealth,line width=0.15mm] (0,0) -- (0,-\axisl/\zd+0.3);
	
	\draw[-stealth,line width=0.15mm] (0.25,0) -- (0.25,-\axisl/\zd+0.4);
	\draw[-stealth,line width=0.15mm] (0.5,0) -- (0.5,-\axisl/\zd+0.3);
	\draw[-stealth,line width=0.15mm] (0.75,0) -- (0.75,-\axisl/\zd);
	\draw[-stealth,line width=0.15mm] (1,0) -- (1,-\axisl/\zd+0.25);
	\draw[-stealth,line width=0.15mm] (1.25,0) -- (1.25,-\axisl/\zd+0.1);
	\draw[-stealth,line width=0.15mm] (1.5,0) -- (1.5,-\axisl/\zd+0.1);
	\draw[-stealth,line width=0.15mm] (1.75,0) -- (1.75,-\axisl/\zd);
	\draw[-stealth,line width=0.15mm] (2,0) -- (2,-\axisl/\zd+0.22);
	\end{tikzpicture}
