...
\begin{figure}
	...
	\draw[-stealth] (-2,0) --  (-2,-\axisl/\zd);
	%\draw[-stealth] (-1.75,0) -- (-1.75,-\axisl/\zd);
	\draw[-stealth] (-1.5,0) -- (-1.5,-\axisl/\zd);
	%\draw[-stealth] (-1.25,0) -- (-1.25,-\axisl/\zd);
	\draw[-stealth] (-1,0) --  (-1,-\axisl/\zd);
	%\draw[-stealth] (-0.75,0) -- (-0.75,-\axisl/\zd);
	\draw[-stealth] (-0.5,0) -- (-0.5,-\axisl/\zd);
	%\draw[-stealth] (-0.25,0) -- (-0.25,-\axisl/\zd);
	\draw[-stealth] (0,0) -- (0,-\axisl/\zd);
	%\draw[-stealth] (0.25,0) -- (0.25,-\axisl/\zd);
	\draw[-stealth] (0.5,0) -- (0.5,-\axisl/\zd);
	%\draw[-stealth] (0.75,0) -- (0.75,-\axisl/\zd);
	\draw[-stealth] (1,0) node[above]{Raggi}-- (1,-\axisl/\zd);
	%\draw[-stealth] (1.25,0) -- (1.25,-\axisl/\zd);
	\draw[-stealth] (1.5,0) -- (1.5,-\axisl/\zd);
	%\draw[-stealth] (1.75,0) -- (1.75,-\axisl/\zd);
	\draw[-stealth] (2,0) -- (2,-\axisl/\zd);
	
	\draw[] (-2.3,-1.3) -- (-1,-1.1) --  (1,-1.4) -- (2.3,-1.3) node[below]{Terreno};
	\end{tikzpicture}
