...
%
\subsubsection{Modello a più Dischi}
Nel modello a più dischi, lo pneumatico sarà rappresentato da più dischi rigidi indeformabili disposti uniformemente lungo la sezione dello stesso. A differenza del caso a singolo disco non sia andrà più a campionare la strada nei quattro punti $Q_i$, si andrà invece a calcolare 
