\chapter{Algoritmi usati nella modellazione}
\label{Geom_Algos}
%
...
\end{itemize}
%
\section{Algoritmi di tipo geometrico}
%
...
%	\end{tikzpicture}
	\includegraphics[width=0.55\linewidth]{Figures/plane-plane}
...
%	\end{tikzpicture}
	\includegraphics[width=0.55\linewidth]{Figures/plane-plane-n}
...
%	\end{tikzpicture}
	\includegraphics[width=0.6\linewidth]{Figures/ray-plane}
	\caption{Vettori dei piani $P_1$, $P_2$ e della retta $L$.}
\end{figure}
\begin{figure}[htbp]
	\centering
...
\begin{itemize}
	...
	\item il triangolo giace nel piano intersecante (vengono considerati 3 punti di intersezione).
\end{itemize}
