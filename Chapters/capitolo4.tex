...
%
\subsection{Caricare la \textit{mesh}}
...
\end{pseudoc}
%
\subsection{Creare lo pneumatico}
...
\end{pseudoc}
%
\subsection{Orientazione dello pneumatico e valutazione del contatto}
Per orientazione dello pneumatico e valutarne il contatto con il manto stradale si utilizzerà il metodo \texttt{setup} della classe \texttt{Tire}.
\begin{pseudoc}
...
\end{pseudoc}
Per estrarre i risultati si andranno a inizializzazione delle variabili reali o vettoriali e poi saranno modificate dai metodi della classe \texttt{Tire} sotto elencati.
\begin{pseudoc}
