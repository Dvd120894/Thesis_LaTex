...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
I tempi rilevati per il modello di pneumatico a singolo disco \texttt{Tire::MagicFormula} sono riportati nelle Tabelle \ref{MFcordolo} e \ref{MFpiano}. Analogamente, i tempi rilevati per il modello di pneumatico a più dischi \texttt{Tire::MultiDisk} sono riportati nelle Tabelle ...
\begin{table}
	\centering
	\begin{tabular}{c|c|c|c|}
		\cline{2-4} 
...
\begin{table}
	...
	\begin{tabular}{c|c|c|c|c|c|}
		...
		& \textbf{Dischi} & \textbf{Punti} & \textbf{Campionamento} & \textbf{Ponderato sull'area} & \textbf{\textit{Mix}} \\ 
		\hline
		\multicolumn{1}{|c|}{$T_{totale}$ [ms]} & 10 & 10 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$T_{step}$ [ms]} & 10 & 10 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\sigma$ [ms$^2$]} & 10 & 10 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\delta$ [ms]} & 10 & 10 &  &  &  \\ 
		\hhline{======}

		\multicolumn{1}{|c|}{$T_{totale}$ [ms]} & 10 & 20 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$T_{step}$ [ms]} & 10 & 20 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\sigma$ [ms$^2$]} & 10 & 20 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\delta$ [ms]} & 10 & 20 &  &  &  \\ 
		\hhline{======}
		
		\multicolumn{1}{|c|}{$T_{totale}$ [ms]} & 20 & 10 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$T_{step}$ [ms]} & 20 & 10 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\sigma$ [ms$^2$]} & 20 & 10 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\delta$ [ms]} & 20 & 10 &  &  &  \\ 
		\hhline{======}
		
		\multicolumn{1}{|c|}{$T_{totale}$ [ms]} & 20 & 20 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$T_{step}$ [ms]} & 20 & 20 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\sigma$ [ms$^2$]} & 20 & 20 &  &  &  \\ 
		\hline 
		\multicolumn{1}{|c|}{$\delta$ [ms]} & 20 & 20 &  &  &  \\ 
		\hline
	\end{tabular}
	\\[0.5cm]
	Pneumatico 205/55R16\\
