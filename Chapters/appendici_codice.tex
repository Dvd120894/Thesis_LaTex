...
\renewcommand{\baselinestretch}{1.0}
\lstinputlisting{../TireGround/tests/MagicFormula-test3.cc}
\renewcommand{\baselinestretch}{1.25}
%
\section{\textit{Tests} per il modello a più dischi}
%
...
\renewcommand{\baselinestretch}{1.0}
\lstinputlisting{../TireGround/tests/MultiDisk-test3.cc}
\renewcommand{\baselinestretch}{1.25}